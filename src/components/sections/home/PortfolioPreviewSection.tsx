...
const PREVIEW_PROJECTS = [
  {
    ...
    software: "AutoCAD",
    desc:     "Pemodelan desain arsitektur dan perencanaan tata letak (space planning) modern untuk gerai kopi di area transit, mengoptimalkan kenyamanan dan alur sirkulasi pengunjung rest area.",
  ...
  },
  {
    ...
    desc:     "Desain fasilitas pencucian dan perawatan mobil (detailing) modern terintegrasi pada kawasan rest area jalan tol.",
  ...
  },
  {
    ...
    software: "AutoCAD",
    desc:     "Perancangan ruang kantor modern yang fokus pada optimalisasi ruang kerja ergonomis, estetik, dan fungsional.",
